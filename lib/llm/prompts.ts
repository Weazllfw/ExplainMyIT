...
${JSON.stringify(
    {
      dns: {
        ...
        signals: {
          domain_age_years: signals.dns!.domain_age_years,
          registrar: signals.dns!.registrar,
          nameservers: signals.dns!.nameservers,
          dns_hosting_provider: signals.dns!.dns_hosting_provider,
        },
      ...
      email: {
        ...
        signals: {
          mx_provider: signals.email!.mx_provider,
          spf_record: signals.email!.spf_record,
          spf_strictness: signals.email!.spf_strictness,
          dkim_present: signals.email!.dkim_present,
          dmarc_policy: signals.email!.dmarc_policy,
        },
        flags: signals.email!.flags,
      },
      tls: {
        ...
        signals: {
          ...
          certificate_expiry_days: signals.tls!.certificate_expiry_days,
          tls_versions_supported: signals.tls!.tls_versions_supported,
        },
        flags: signals.tls!.flags,
      },
      techstack: {
        block_name: 'Website Technology & Hosting',
        confidence: signals.techstack!.confidence,
        signals: {
          cms_detected: signals.techstack!.cms_detected,
          cdn_provider: signals.techstack!.cdn_provider,
          hosting_provider: signals.techstack!.hosting_provider,
          technologies: signals.techstack!.technologies,
        },
        flags: signals.techstack!.flags,
      },
      exposure: {
        ...
        signals: {
          ...
          hosting_region: signals.exposure!.hosting_region,
        },
        flags: signals.exposure!.flags,
      },
      hibp: {
        block_name: 'Breach History',
        confidence: signals.hibp!.confidence,
        signals: {
          total_breach_count: signals.hibp!.total_breach_count,
          most_recent_breach_date: signals.hibp!.most_recent_breach_date,
          breaches: signals.hibp!.breaches.slice(0, 3), // First 3 for context
        },
        flags: signals.hibp!.flags,
      },
    },
    null,
    2
...
${JSON.stringify(
    {
      blocks: {
        dns: {
          success: signals.dns!.success,
          confidence: signals.dns!.confidence,
          domain_age_years: signals.dns!.domain_age_years,
          flags: signals.dns!.flags,
        },
        email: {
          success: signals.email!.success,
          confidence: signals.email!.confidence,
          mx_provider: signals.email!.mx_provider,
          dmarc_policy: signals.email!.dmarc_policy,
          flags: signals.email!.flags,
        ...
        techstack: {
          success: signals.techstack!.success,
          confidence: signals.techstack!.confidence,
          cms_detected: signals.techstack!.cms_detected,
          cdn_provider: signals.techstack!.cdn_provider,
          flags: signals.techstack!.flags,
        ...
        exposure: {
          success: signals.exposure!.success,
          confidence: signals.exposure!.confidence,
          infrastructure_type: signals.exposure!.infrastructure_type,
          flags: signals.exposure!.flags,
        },
        hibp: {
          success: signals.hibp!.success,
          confidence: signals.hibp!.confidence,
          total_breach_count: signals.hibp!.total_breach_count,
          flags: signals.hibp!.flags,
        },
