/**
 * Email Template: Confirm Signup (for Supabase)
 * 
 * Sent when user signs up and needs to verify their email
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="margin: 0 0 24px 0; color: #475569; font-size: 15px; line-height: 1.7;">
                Thanks for signing up for Explain My IT! We're excited to help you understand and monitor your IT setup.
              </p>
            ...
            <td style="padding: 0 30px 40px 30px;">
              <div style="background: #fef3c7; border-left: 4px solid #f59e0b; border-radius: 8px; padding: 20px; margin: 0;">
                <p style="margin: 0; color: #92400e; font-size: 14px; line-height: 1.6;">
                  ...
                  If you didn't sign up for Explain My IT, you can safely ignore this email. The link will expire in 24 hours.
                </p>
              </div>
            </td>
          </tr>
