/**
 * Email Template: Reset Password (for Supabase)
 * 
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="margin: 0 0 24px 0; color: #475569; font-size: 15px; line-height: 1.7;">
                We received a request to reset the password for your Explain My IT account. Click the button below to choose a new password.
              </p>
            ...
            <td style="padding: 0 30px 40px 30px;">
              <div style="background: #fef3c7; border-left: 4px solid #f59e0b; border-radius: 8px; padding: 20px; margin: 0;">
                <p style="margin: 0; color: #92400e; font-size: 14px; line-height: 1.6;">
                  ...
                  If you didn't try to reset your password, someone may be trying to access your account. Please ignore this email and consider changing your password if you're concerned.
                </p>
              </div>
            </td>
          </tr>
...
We received a request to reset the password for your Explain My IT account. Click the link below to choose a new password.
